...
// H/L temp charging limit reached UI
...
#define MAX_STEP_CHG_ENTRIES 24
...
static int smb2_parse_dt(struct smb2 *chip)
{
	...
	chg->fih_dcp_2a_enable = of_property_read_bool(node, "fih,dcp-2a-function-enable");
